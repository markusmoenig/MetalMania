...
/// Draws a sphere
public class MMDrawSphere : MMDrawable
{
    ...
    {
        let function = renderer.defaultLibrary.makeFunction( name: "mmSphereDrawable" )
...
/// Draws a Box
public class MMDrawBox : MMDrawable
{
    let mmRenderer  : MMRenderer
    var state       : MTLRenderPipelineState!
    let rotatedState: MTLRenderPipelineState!

    required public init( _ renderer : MMRenderer )
    {
    ...
    public func draw( x: Float, y: Float, width: Float, height: Float, round: Float = 0, borderSize: Float = 0, fillColor: SIMD4<Float>, borderColor: SIMD4<Float> = SIMD4<Float>(repeating: 0), fragment: MMFragment? = nil )
    {
        let scaleFactor : Float = mmRenderer.mmView.scaleFactor
        let settings: [Float] = [
    ...
    public func drawRotated( x: Float, y: Float, width: Float, height: Float, round: Float = 0, borderSize: Float = 0, fillColor: SIMD4<Float>, borderColor: SIMD4<Float> = SIMD4<Float>(repeating: 0), rotation: Float )
    {
        let border : Float = 20
...
/// Draws a Box Pattern
public class MMDrawBoxPattern : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
/// Draws a line
public class MMDrawLine : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
/// Draws a Spline
public class MMDrawSpline : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
public class MMDrawBoxGradient : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
public class MMDrawBoxedMenu : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
/// Draws a box with three lines inside representing a menu
public class MMDrawBoxedShape : MMDrawable
{
    let mmRenderer  : MMRenderer
    var state       : MTLRenderPipelineState!
...
/// Draws a texture
public class MMDrawTexture : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
/// Draws custom code
public class MMDrawCustomState : MMDrawable
{
    let mmRenderer : MMRenderer
    var state      : MTLRenderPipelineState!
    ...
    func createState(source: String, name: String) -> MTLRenderPipelineState?
    {
        ...
        pipelineStateDescriptor.vertexFunction = mmRenderer.defaultLibrary.makeFunction( name: "mmQuadVertexShader" )
...
/// Draws text
public class MMDrawText : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
    ...
    @discardableResult public func drawText( _ font: MMFont, text: String, x: Float, y: Float, scale: Float = 1.0, color: SIMD4<Float> = SIMD4<Float>(repeating: 1), textBuffer: MMTextBuffer? = nil, fragment: MMFragment? = nil ) -> MMTextBuffer?
    {
        let adjScale : Float = scale / 2
    ...
    @discardableResult public func drawTextCentered( _ font: MMFont, text: String, x: Float, y: Float, width: Float, height: Float, scale: Float = 1.0, color: SIMD4<Float> = SIMD4<Float>(repeating: 1), textBuffer: MMTextBuffer? = nil, fragment: MMFragment? = nil ) -> MMTextBuffer?
    {
...
/// Draws a Color Wheel
public class MMDrawColorWheel : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
...
/// Draws an arc
public class MMDrawArc : MMDrawable
{
    let mmRenderer : MMRenderer
    var state : MTLRenderPipelineState!
