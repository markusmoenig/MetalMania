...
open class MMWidget
{
    ...
    open func mouseDown(_ event: MMMouseEvent)
    {
    }
    
    open func mouseUp(_ event: MMMouseEvent)
    {
    }
    
    open func mouseMoved(_ event: MMMouseEvent)
    {
    }
    
    open func mouseScrolled(_ event: MMMouseEvent)
    {
    }
    
    open func mouseEnter(_ event:MMMouseEvent)
    {
    }
    
    open func mouseLeave(_ event:MMMouseEvent)
    {
    }
    
    open func keyDown(_ event: MMKeyEvent)
    {
    }
    
    open func keyUp(_ event: MMKeyEvent)
    {
    }
    
    open func draw(xOffset: Float = 0, yOffset: Float = 0)
    {
    }
    
    open func dragEnded(event: MMMouseEvent, dragSource: MMDragSource)
    {
    }
    
    open func dragTerminated()
    {
    }
    
    open func pinchGesture(_ scale: Float,_ firstTouch: Bool)
    {
    }

    open func _clicked(_ event: MMMouseEvent)
    {
        if clicked != nil {
            clicked!(event)
        }
