...
open class MMView : MMBaseView {

    var renderer        : MMRenderer!
    var textureLoader   : MTKTextureLoader!
    
    // --- Regions
    public var leftRegion      : MMRegion?
    public var topRegion       : MMRegion?
    public var rightRegion     : MMRegion?
    public var bottomRegion    : MMRegion?
    public var editorRegion    : MMRegion?

    // --- Drawables
    public var drawSphere      : MMDrawSphere!
    public var drawBox         : MMDrawBox!
    public var drawBoxPattern  : MMDrawBoxPattern!
    public var drawBoxGradient : MMDrawBoxGradient!
    public var drawBoxedMenu   : MMDrawBoxedMenu!
    public var drawBoxedShape  : MMDrawBoxedShape!
    public var drawTexture     : MMDrawTexture!
    public var drawText        : MMDrawText!
    public var drawCustomState : MMDrawCustomState!
    public var drawLine        : MMDrawLine!
    public var drawSpline      : MMDrawSpline!
    public var drawColorWheel  : MMDrawColorWheel!
    public var drawArc         : MMDrawArc!

    // --- Fonts
    public var openSans        : MMFont!
    public var gameCuben       : MMFont!
    public var square          : MMFont!
