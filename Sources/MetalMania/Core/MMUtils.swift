...
public class MMRect
{
    ...
    public init( _ x : Float, _ y : Float, _ width: Float, _ height : Float, scale: Float = 1 )
    {
    ...
    public init(_ rect : MMRect)
    {
        x = rect.x; y = rect.y
        width = rect.width; height = rect.height
    }
    
    public func set( _ x : Float, _ y : Float, _ width: Float, _ height : Float, scale: Float = 1 )
    {
        self.x = x * scale; self.y = y * scale; self.width = width * scale; self.height = height * scale
    }
    
    /// Copy the content of the given rect
    public func copy(_ rect : MMRect)
    {
        x = rect.x; y = rect.y
        width = rect.width; height = rect.height
    }
    ...
    public func contains( _ x : Float, _ y : Float, _ scale : Float ) -> Bool
    {
    ...
    /// Intersect the rects
    public func intersect(_ rect: MMRect)
    {
    ...
    /// Merge the rects
    public func merge(_ rect: MMRect)
    {
